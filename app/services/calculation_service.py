...
class CalculationService:
    ...
    def calculate_comparison(
        ...
        comparison = {
            ...
            "cheaper_option": "lambda" if lambda_result["total_cost"] < vm_result["total_cost"] else "vm"
        }
        
        if include_break_even:
            # Calculate break-even point (simplified)
            break_even_executions = self._calculate_break_even_point(lambda_data, vm_data)
