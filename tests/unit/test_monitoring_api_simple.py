...
class TestMonitoringAPI:
    ...
    def test_health_check_with_observability(self, client, mock_monitoring):
        ...
        mock_observability.health_checker.get_health_summary.return_value = (
            mock_health_data
        )
    ...
    def test_get_alerts_with_alerting(self, client, mock_monitoring):
        ...
        mock_alerting.get_dashboard_data.return_value = mock_alerts_dashboard
    ...
    def test_acknowledge_alert(self, client, mock_monitoring):
        ...
        response = client.post(
            "/api/v1/monitoring/alerts/alert123/acknowledge",
            json={"user": "test_user"},
            content_type="application/json",
        )
        assert response.status_code == 200
    ...
    def test_suppress_alert(self, client, mock_monitoring):
        ...
        response = client.post(
            "/api/v1/monitoring/alerts/alert123/suppress",
    ...
    def test_get_traces_with_apm(self, client, mock_monitoring):
        ...
        mock_apm.get_dashboard_data.return_value = mock_dashboard_data
    ...
    def test_get_performance_with_monitoring(self, client, mock_monitoring):
        ...
        mock_performance.get_dashboard_data.return_value = mock_performance_data
        mock_monitoring.get_service.return_value = mock_performance
    ...
    def test_get_config_with_monitoring(self, client, mock_monitoring):
        ...
        mock_config_obj.config = mock_config_data
        mock_monitoring.config = mock_config_obj
    ...
    def test_put_config_no_monitoring(self, client):
        ...
        config_data = {"apm.sampling_rate": 0.2, "logging.level": "DEBUG"}
    ...
    def test_missing_content_type(self, client):
        ...
        response = client.post("/api/v1/monitoring/metrics", data='{"name": "test"}')
