...
class TestValidationUtilities:
    ...
    def test_safe_int_conversion_below_min(self):
        ...
        with pytest.raises(
            ValidationError, match="test_field must be between 10 and 100"
        ):
    ...
    def test_safe_int_conversion_invalid_string(self):
        ...
        with pytest.raises(
            ValidationError, match="Invalid test_field: must be a valid integer"
        ):
    ...
    def test_safe_float_conversion_below_min(self):
        ...
        with pytest.raises(
            ValidationError, match="test_field must be between 1.0 and 10.0"
        ):
    ...
    def test_safe_float_conversion_invalid_string(self):
        ...
        with pytest.raises(
            ValidationError, match="Invalid test_field: must be a valid number"
        ):
...
class TestLambdaInputValidation:
    ...
    def test_validate_lambda_inputs_missing_memory(self):
        ...
        with pytest.raises(
            ValidationError, match="Memory size must be between 128 and 10240"
        ):
...
class TestVMInputValidation:
    ...
    def test_validate_vm_inputs_missing_provider(self):
        ...
        data = {"instance_type": "t3.small", "region": "ap-northeast-1"}
    ...
    def test_validate_vm_inputs_missing_instance_type(self):
        ...
        data = {"provider": "aws_ec2", "region": "ap-northeast-1"}
...
class TestServerlessInputValidation:
    ...
    def test_validate_serverless_inputs_invalid_provider(self):
        ...
        # The serverless validator doesn't check specific providers - that's done
        # at endpoint level
        result = validate_serverless_inputs(data)
    ...
    def test_validate_serverless_inputs_invalid_cpu_count(self):
        ...
        with pytest.raises(
            ValidationError, match="CPU count must be between 0.1 and 64.0"
        ):
            validate_serverless_inputs(data)
