...
class TestAlert:
    ...
    def test_alert_creation(self):
        ...
        assert alert.rule.name == "cpu_high"
...
class TestAlertingService:
    ...
    def test_add_alert_rule(self, alerting_service, sample_alert_rule):
        ...
        assert sample_alert_rule in alerting_service.alert_rules
    ...
    def test_remove_alert_rule(self, alerting_service, sample_alert_rule):
        ...
        assert sample_alert_rule not in alerting_service.alert_rules
...
class TestEdgeCases:
    ...
    def test_large_alert_volume_handling(self):
        ...
        # Should limit history size due to deque maxlen
        assert len(service.alert_history) <= 1000  # Should be limited
