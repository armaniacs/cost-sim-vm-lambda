...
class TestCalculationService:
    ...
    @patch("app.services.calculation_service.validate_lambda_inputs")
    @patch("app.services.calculation_service.get_lambda_calculator")
    def test_calculate_lambda_cost_with_custom_rates(
        self, mock_get_calculator, mock_validate
    ):
    ...
    def test_calculate_serverless_cost_success(
        self, mock_get_calculator, mock_validate
    ):
    ...
    def test_calculate_comparison_vm_cheaper(self, mock_vm_calc, mock_lambda_calc):
        ...
        result = service.calculate_comparison(
            lambda_data, vm_data, include_break_even=False
        )
