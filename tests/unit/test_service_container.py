...
class TestGlobalFunctions:
    ...
    def test_get_lambda_calculator_with_config(self, mock_get_container):
        ...
        mock_container.register_service(
            "lambda_calculator", lambda pricing_config=None: mock_calculator
        )
    ...
    def test_get_lambda_calculator_default_config(
        self, mock_get_pricing, mock_get_container
    ):
    ...
    @patch("app.services.service_container.get_container")
    @patch(
        "app.services.service_container.ServiceContainer.get_pricing_config",
    ...
    def test_get_serverless_calculator(self, mock_get_container):
        ...
        mock_container.register_service(
            "serverless_calculator", lambda: mock_calculator
        )
    ...
    def test_get_egress_calculator_with_custom_rates(self, mock_get_container):
        ...
        mock_container.register_service(
            "egress_calculator", lambda custom_rates=None: mock_calculator
        )
